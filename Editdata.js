...
const Editdata = () => {
    const [dataUser, setDataUser] = useState([]); // Definisikan sebagai state dengan nilai awal array kosong
    const [refreshPage, setRefreshPage] = useState(false); // Definisikan sebagai state dengan nilai awal false
